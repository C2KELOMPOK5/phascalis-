...
$tableName = "history1";
for ($i = 1; mysqli_num_rows(mysqli_query($conn, "SHOW TABLES LIKE '$tableName'")) > 0; $i++) {
  $tableName = "history" . $i;
}
...
$sql = "INSERT INTO $tableName (username, picked_card) VALUES
        ('$nama1', '$pickedkard1'),
        ('$nama2', '$pickedkard2')";
if (mysqli_query($conn, $sql)) {
...
// get the image elements inside each container
const images11 = containerkartu1.getElementsByTagName("img");
const images22 = containerkartu2.getElementsByTagName("img");

// loop through the image elements and disable the context menu and drag events
